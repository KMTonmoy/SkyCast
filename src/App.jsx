          ...
          <>
            ...
            <div className='flex justify-between items-center mb-6'>
              <div className='flex flex-col items-center'>
                ...
                <p className='text-sm'>Feels Like: {weatherData.current.feelslike_c}°C</p>
              </div>
            ...
            <div className='mb-6'>
              ...
              <div className='flex justify-between'>
                <div className='flex flex-col'>
                  <span>Max Temp: {weatherData.forecast.forecastday[0].day.maxtemp_c}°C</span>
                  <span>Min Temp: {weatherData.forecast.forecastday[0].day.mintemp_c}°C</span>
                </div>
                <div className='flex flex-col'>
